...
tm_shape(world_cities) +
  tm_dots() # Define how to plot the second object
...
```{r}
tm_shape(world_elevation, bbox = world_cities) + # Bounding box = extend restrict
  tm_raster() +
tm_shape(world_vector) +
  tm_borders()
...
tm_shape(world_vector) +
  tm_polygons(fill = "life_expectancy",
              ...
              fill.legend = tm_legend(tittle = "Life Expectancy (years)",
...
tm_shape(world_vector) +
  tm_polygons(fill = "life_expectancy",
              ...
              fill.legend = tm_legend(tittle = "Life Expactancy (years)"))
...
```{r}
tm_shape(world_vector) +
  tm_polygons(fill = "life_ecpectancy",
  fill.scale = tm_scale(values = "brewer.yl_gn"),
  fill.legend = tm_legend(tittle = "Life Expectancy"))
...
tm_shape(world_vector) +
  tm_fill() +
  tm_graticules() # The oreder in the map is the order in the layer in code
```
...
tm_shape(world_vector) +
  tm_polygons(#fill = "wb_income_region",
              fill = "gdp_per_cap",
              #fill.scale = tm_scale(breaks = c(0, 5000, 20000, 40000, 80000)),
