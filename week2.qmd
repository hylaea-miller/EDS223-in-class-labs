...
```{r}
# Create dataframe of attribute about London
...
world %>% 
  ...
  slice_max(lifeExp) %>% 
  st_drop_geometry() # Drop geometry to not select the column polygon. Not overload
```
